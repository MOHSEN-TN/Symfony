...
class RegistrationController extends AbstractController
{
    ...
    {   
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'Un code a été envoye à l\'adresse suivante :'. $UserEmail .' Veuillez se connecter  afin de confirmer votre compte TEKUPGYM.');
    ...
    public function addAdminJson(Request $req, NormalizerInterface $normalizer)
    {
        $randomInt = random_int(100000, 999999);
        ...
        $user->setNom('Admin');
        $user->setPrenom('Tekup');
        $user->setEmail('admin@tekup.tn');
        ...
        $jsonContent = $normalizer->normalize($user,'json',['groups'=>'users']);
        return new Response("Admin Added Succesfully" . json_encode($jsonContent));
